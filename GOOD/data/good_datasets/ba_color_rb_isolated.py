...
class BAColorRBIsolated(InMemoryDataset):
    """
    Same dataset as BAColorGVIsolated, but instead of having GV isolated we have for each sample we have an isolated R or B
    ...
    def __init__(self, root: str, domain: str = 'basis', shift: str = 'no_shift', subset: str = 'train', transform=None,
        ...
        super(BAColorRBIsolated, self).__init__(root, transform, pre_transform)
    ...
    def load(dataset_root: str, domain: str= 'basis', shift: str = 'no_shift', generate: bool = False, debias: bool =False, model_name:str=None, add_pos_feat:bool=False):
        ...
        dataset = BAColorRBIsolated(dataset_root, domain=domain)
        ood1_dataset = BAColorRBIsolated(dataset_root, domain=domain, shift="debug")
        ood2_dataset = BAColorRBIsolated(dataset_root, domain=domain, shift="debug")        
